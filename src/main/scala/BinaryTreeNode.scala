...
import BinaryTreeSet.{ContainsResult,OperationFinished,Contains,Insert,Remove,GC}
...
class BinaryTreeNode(val elem: Int, initiallyRemoved: Boolean) extends Actor {
  import BinaryTreeNode.{Position,Right,Left,CopyTo,CopyFinished}

  val subtrees = Map[Position, ActorRef]()
